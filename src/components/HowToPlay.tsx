      ...
      <div className="space-y-6 max-w-[350px]">
        <section>
          ...
          <p className="text-sm leading-relaxed">
            Each player starts with 26 cards. Players draw cards simultaneously. Higher card wins both cards! Be aware of the 4 minute timer - if it runs out, the game ends without declaring a winner.
          </p>
        </section>
